	...
	if($userlevel == "ADMINISTRATOR"){	
			echo '<script>
				...
				if (isset($_POST["btn-update"])){
					...
					//HISTORY INSERTION
						$History1 = "PROJECT DETAILS FROM CAS HAS CHANGED";
						...
						echo'<script>window.location.replace("staff_cas.php?");</script>';
					...
					height: 60px;
						...
						<br>
								...
								<option name="new_Course" <?php if($db_Course == "BS in Psychology"){ echo "selected";} ?> value="BS in Psychology">BS in Psychology</option>
								 ...
								 <input type="text" class="input"  placeholder="Department" name="new_Department" readonly autocomplete="on" value="College of Arts & Science" required maxlength="50" minlength="2"/>
						<br>
