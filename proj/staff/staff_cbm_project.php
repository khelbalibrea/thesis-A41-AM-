						...
						<body>
							<nav class="navbar navbar-inverse">
								<div class="container-fluid">
								  ...
								  <h4 style="font-family: Georgia; margin-bottom: 2%;"><b><center><i class="fa fa-file-pdf-o"></i> NEW CBM PROJECT</center></b></h4>
							 	<center><form  action="staff_cbm_upload.php?" method="POST" enctype="multipart/form-data">
