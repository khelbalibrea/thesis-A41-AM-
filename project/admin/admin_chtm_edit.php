			...
			echo '<script>
				...
				if (isset($_POST["btn-update"])){
					...
					//HISTORY INSERTION
						$History1 = "PROJECT DETAILS FROM CHTM HAS CHANGED";
						...
						echo'<script>window.location.replace("admin_chtm.php?");</script>';
					...
					height: 60px;
						...
						<br>
								...
								<option name="new_Course" <?php if($db_Course == "BS in Hotel and Restaurant Management"){ echo "selected";} ?> value="BS in Hotel and Restaurant Management">BS in Hotel and Restaurant Management</option>
								 ...
								 <input type="text" class="input"  placeholder="Department" name="new_Department" readonly autocomplete="on" value="College of Hotel Tourism Management" required maxlength="50" minlength="2"/>
						<br>
