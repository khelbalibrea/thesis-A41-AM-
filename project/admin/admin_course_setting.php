		...
		if(isset($_POST['btn-add'])){
			...
			$query = mysqli_query($connection, "SELECT * FROM course WHERE coursename='$CourseName'");
			...
			if ($count > 0){
				...
				//Registration
				mysqli_query($connection, "INSERT INTO course(coursename, coursecode, college) VALUES('$CourseName', '$CourseCode', '$Course')");
	...
	<center><img src="../assets/img/college.png" width="6%" style="margin-top: 5px;"><br><h5 style="font-weight: bold;">ADD COURSE</h5>

				<center><form method="POST" action="#" style="margin-top: 20px;">
				<!-- <input type="hidden" name="new_ID" value="<?php echo $infoID; ?>"/> -->
				<input id="course" type="text" name="course_name" required placeholder="Enter Course" class="input-lg" maxlength="100" minlength="3"/><br>
				<input id="coursecode" type="text" name="course_code" required placeholder="Enter Course Code" class="input-lg" maxlength="10" minlength="3"/><br>
				...
				<select class="input" id="course" required name="Course">
					<?php
						$link = mysqli_query($connection, "SELECT collegename, collegecode FROM college");
				...
				<br>
						 ...
						 <input type="submit" value="Add" onclick="return confirm(' ARE YOU SURE YOU WANT TO ADD THIS COURSE?')" name="btn-add" id="add" class="btn btn-primary btn-medium"/><br>
