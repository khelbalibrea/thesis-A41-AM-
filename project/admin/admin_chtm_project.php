			...
			height: 60px;
						...
						<body>
							<nav class="navbar navbar-inverse">
								<div class="container-fluid">
								  ...
								  <h4 style="font-family: Georgia; margin-bottom: 2%;"><b><center><i class="fa fa-file-pdf-o"></i> NEW CHTM PROJECT</center></b></h4>
							 	<center><form  action="admin_chtm_upload.php?" method="POST" enctype="multipart/form-data">
				...
				<br>
						...
						<option name="Course" value="BS in Tourism Management">BS in Tourism Management</option>
						<option name="Course" value="BS in Hotel and Restaurant Management">BS in Hotel and Restaurant Management</option>
						 </select> <br>
						 
						 <input type="text" class="input"  placeholder="Department" name="Department" readonly autocomplete="on" value="College of Hotel Tourism Management" required maxlength="50" minlength="2"/>
				<br>
						...
						<option name="Proj-type" value="Feasibility Study">Feasibility Study</option>
						 ...
						 <textarea name="Description" required id="description" class="input" placeholder="Project Description" ></textarea><br>
								...
								<br><a id="btn-reg1" class="btn btn-success btn-medium" role="button" href="admin_chtm.php?">Cancel</a>
								</form>
