			...
			echo '<script>
				...
				if (isset($_POST["btn-update"])){
					...
					//HISTORY INSERTION
						$History1 = "PROJECT DETAILS FROM COE HAS CHANGED";
						...
						echo'<script>window.location.replace("admin_coe.php?");</script>';
					...
					height: 60px;
						...
						<br>
								...
								<option name="new_Course" <?php if($db_Course == "BS in Education"){ echo "selected";} ?> value="BS in Education">BS in Education</option>
								 ...
								 <input type="text" class="input"  placeholder="Department" name="new_Department" readonly autocomplete="on" value="College of Education" required maxlength="50" minlength="2"/>
						<br>
