										...
										<nav class="navbar navbar-inverse">
											<div class="container-fluid">
												<div class="navbar-header">
													...
													<a  role="button" class="btn btn-primary btn-med" style="margin-right: 100%;" name="add-project" href="staff_chtm_project.php?"><i class ="fa fa-fw fa-plus"></i> Store Project</a>
														...
														while($row = mysqli_fetch_assoc($view_query)){
															...
															// $full_name = ucfirst($db_Fname) . " " . ucfirst($db_Mname[0]) . ". " . ucfirst($db_Lname);
																...
																<tr> 
																	...
																	<center><a id='edit' class='btn btn-success'  href='staff_chtm_view.php?ID=$ID'><i class='fa fa-file-pdf-o'></i> View</a> 
																	<center><a id='edit' class='btn btn-warning'  href='staff_chtm_edit.php?ID=$ID'><i class='fa fa-fw fa-pencil'></i> Edit</a> 
																	</td>	
																	</td>
