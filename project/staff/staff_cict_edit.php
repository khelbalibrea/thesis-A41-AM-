...
if($userlevel == "ADMINISTRATOR"){	
			echo '<script>
				...
				if (isset($_POST["btn-update"])){
					...
					//HISTORY INSERTION
						$History1 = "PROJECT DETAILS FROM CICT HAS CHANGED";
						...
						echo'<script>window.location.replace("staff_cict.php?");</script>';
					...
					height: 60px;
						...
						<br>
								...
								<option name="new_Course" <?php if($db_Course == "BS in Information System"){ echo "selected";} ?> value="BS in Information System">BS in Information System</option>
								 ...
								 <input type="text" class="input"  placeholder="Department" name="new_Department" readonly autocomplete="on" value="College of Business Management" required maxlength="50" minlength="2"/>
						<br>
								...
								<option name="new_ProjectType" <?php if($db_ProjectType == "Feasibility Study"){ echo "selected";} ?> value="Feasibility Study">Feasibility Study</option>
								 ...
								 <textarea name="new_Description" required id="description" class="input" placeholder="Project Description" ><?php echo $db_Description; ?></textarea><br>
										...
										<br><a id="btn-reg1" class="btn btn-success btn-medium" role="button" href="staff_cict.php?">Cancel</a>
										</form>
