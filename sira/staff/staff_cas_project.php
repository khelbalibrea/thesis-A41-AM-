						...
						<body>
							<nav class="navbar navbar-inverse">
								<div class="container-fluid">
							 	...
							 	<center><form  action="staff_cas_upload.php?" method="POST" enctype="multipart/form-data">
				...
				<br>
						...
						<option name="Proj-type" value="Feasibility Study">Feasibility Study</option>
						 ...
						 <textarea name="Description" required id="description" class="input" placeholder="Project Description" ></textarea><br>
								...
								<br><a id="btn-reg1" class="btn btn-success btn-medium" role="button" href="staff_cas.php?">Cancel</a>
								</form>
