										...
										<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="#" value=""><i class="fa fa-fw fa-id-badge"></i> ACCOUNT MANAGEMENT</a>
											<ul class="dropdown-menu" role="menu">
												...
												<li><a href="admin_clientaccounts.php?"><i class="fa fa-fw fa-users"></i> View Client List</a></li>
													...
													<div class="container">
													<form method="POST">
													<h4 style="font-family: Georgia;"><b><center><img src="../assets/img/chtm.jpg" width="7%"></img> COLLEGE OF HOSPITALITY AND TOURISM MANAGEMENT ( CHTM )</center></b></h4>
													
													<a  role="button" class="btn btn-primary btn-med" style="margin-right: 100%;" name="add-project" href="admin_chtm_project.php?"><i class ="fa fa-fw fa-plus"></i> Store Project</a>
											...
											<?php
													...
													$Dept = "Q29sbGVnZSBvZiBIb3RlbCBUb3VyaXNtIE1hbmFnZW1lbnQ=";
														...
														while($row = mysqli_fetch_assoc($view_query)){
															...
															// $full_name = ucfirst($db_Fname) . " " . ucfirst($db_Mname[0]) . ". " . ucfirst($db_Lname);
																...
																<tr> 
																	...
																	<center><a id='edit' class='btn btn-success'  href='admin_chtm_view.php?ID=$ID'><i class='fa fa-file-pdf-o'></i> View</a> 
																	<center><a id='edit' class='btn btn-warning'  href='admin_chtm_edit.php?ID=$ID'><i class='fa fa-fw fa-pencil'></i> Edit</a> 
																	</td>	
																	</td>
