										...
										<nav class="navbar navbar-inverse">
											...
											<ul class="dropdown-menu" role="menu">
												...
												<li><a href="admin_clientaccounts.php?"><i class="fa fa-fw fa-users"></i> View Client List</a></li>
													...
													<a  role="button" class="btn btn-primary btn-med" style="margin-right: 100%;" name="add-project" href="admin_ccj_project.php?"><i class ="fa fa-fw fa-plus"></i> Store Project</a>
														...
														while($row = mysqli_fetch_assoc($view_query)){
															...
															// $full_name = ucfirst($db_Fname) . " " . ucfirst($db_Mname[0]) . ". " . ucfirst($db_Lname);
																...
																<tr> 
																	...
																	<center><a id='edit' class='btn btn-success'  href='admin_ccj_view.php?ID=$ID'><i class='fa fa-file-pdf-o'></i> View</a> 
																	<center><a id='edit' class='btn btn-warning'  href='admin_ccj_edit.php?ID=$ID'><i class='fa fa-fw fa-pencil'></i> Edit</a> 
																	</td>	
																	</td>
