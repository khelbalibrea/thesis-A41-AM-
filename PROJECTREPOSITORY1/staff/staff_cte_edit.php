	...
	if($userlevel == "ADMINISTRATOR"){	
			echo '<script>
				...
				if (isset($_POST["btn-update"])){
					...
					//HISTORY INSERTION
						$History1 = "PROJECT DETAILS FROM CTE HAS CHANGED";
						...
						echo'<script>window.location.replace("staff_cte.php?");</script>';
					...
					height: 60px;
						...
						<br>
								...
								<option name="new_Course" <?php if($db_Course == "BS in Mechanical Engineering"){ echo "selected";} ?> value="BS in Mechanical Engineering">BS in Mechanical Engineering</option>
								 </select> <br>
								 
								 <input type="text" class="input"  placeholder="Department" name="new_Department" readonly autocomplete="on" value="College of Techonology & Engineering" required maxlength="50" minlength="2"/>
						<br>
