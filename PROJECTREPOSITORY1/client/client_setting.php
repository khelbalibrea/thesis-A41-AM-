	...
	$get_record = mysqli_query($connection, "SELECT * FROM account WHERE ID='$infoID'");
			 ...
			 while ($row = mysqli_fetch_assoc($get_record)){
					...
					$History_Description = "Q0xJRU5UIEFDQ09VTlQgQ0hBTkdFRA==";
						$History_Status = 1;
	...
	<center><img src="../assets/img/Avatar.png" width="6%" style="margin-top: 5px;"><br><h5 style="font-weight: bold;">CLIENT</h5>
				...
				<input id="mname" type="password" name="new_Password" required placeholder="Confirm New Password" class="input-lg" maxlength="20" minlength="3"/><br>
						 ...
						 <a role="button" href="client_home.php?" name="btn-cancel" id="cancel" class="btn btn-success btn-medium">Cancel</a>
